book={
       ...
       'kitchen' : {'desc':"You are in the kitchen", 'choices' : ['eat the cake', "don't eat the cake"]},
       'eat the cake':{'desc':"You are in the eat",'choices':['have a glass of water','wash the plate']},
       "don't eat the cake":{'desc':"You are in the dont",'choices':['put the cake in the fridge','sit down']},
       }
